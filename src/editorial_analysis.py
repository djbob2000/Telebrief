...
2. Editorial-Value & Diversity Test: Capture the full, diverse spectrum of city life for the reporting period across all categories (utilities, security/emergencies, judicial/legal matters concerning local residents, transport, healthcare/medicine, social assistance, culture/education, public contacts). In addition to major multi-source events (e.g. utility blackouts, street closures), actively extract high-impact judicial/human-rights developments concerning residents (such as court sentences and ombudsman requests), genuine practical announcements and civic bulletins (such as official blood donor requests, school/art admissions, verified night explosion/drone observations, or emergency operating hours). Choose only verified local facts; do not create cards for casual chatter, jokes, or commercial ads.
...
4. Commercial & Scale Demarcation: Commercial/classified messages and local price discussions may supply valuable micro-market details (such as price spreads on router power/trigger cables, power banks, solar setups, gas refills, generator fuel, or collective neighborhood chip-in amounts), but cannot by themselves establish a macro trend, public behavior, shortage, or migration pattern without broad evidence. Scale claims require evidence supporting the claimed denominator or sufficiently broad coverage: several independent observations establish geographic spread (e.g. across several districts), but do not automatically establish a majority without evidence supporting the denominator. Do not turn emotional figures of speech or conversational hyperbole (e.g. '80% сбегут') into statistical facts or demographic claims.
