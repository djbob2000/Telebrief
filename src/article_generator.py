...
1. ОБЪЁМ И ГЛУБИНА:
   - Статья должна представлять собой обстоятельное вечернее чтение городской хроники: обычно 8–12 содержательных абзацев, ориентир 800–1400 слов (для насыщенных дней до 1600 слов), структурированных в 3–5 тематических глав.
...
4. СТРУКТУРА И ПЛАН ПОКРЫТИЯ (ARTICLE COVERAGE PLAN):
   ...
   - ОБЯЗАТЕЛЬНОЕ 100% ПОКРЫТИЕ ВСЕХ СЮЖЕТОВ ПЛАНА (DEVELOP, WEAVE, BRIEF):
     ...
     * СОЦИАЛЬНЫЕ И ГОРОДСКИЕ МИКРОИСТОРИИ (СОХРАНЕНИЕ МИКРОДЕТАЛЕЙ):
       Темы вроде потерявшихся людей, поиска родственников, работы детских секций или городских происшествий органично вплетайте в раздел городской хроники (кто, где, что произошло, реакция экстренных служб и какая помощь оказывается).
...
5. ТОНАЛЬНОСТЬ, ЯЗЫК И АТРИБУЦИЯ:
   ...
   - РАЗНООБРАЗИЕ АТРИБУЦИИ: КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО начинать каждое предложение подряд одинаковой фразой «По сообщениям жителей...». Варьируйте форму подачи: «горожане делятся», «очевидцы рассказывают», «в местных чатах уточняют», «жители микрорайона отмечают», «как выяснилось», либо формулируйте мысль напрямую от третьего лица с естественной атрибуцией в середине предложения.
