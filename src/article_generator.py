...
4. ПРАВИЛО ОДНОГО ПРЕДЛОЖЕНИЯ ДЛЯ КОММЕРЧЕСКИХ ТЕМ:
   ...
   - КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО писать любые мета-отчёты или мета-комментарии об опущенных контактах, телефонах или датах («(контактные данные опущены)», «телефоны не указываются», «контакты скрыты», «номера не публикуются», «как сообщалось ранее»). Промо-данные и технические детали опускаются абсолютно молча, без комментариев в тексте!
...
4. Прямая речь, синтез сообщений жителей и запрет на «ленту чата» (QUOTE ALLOWLIST):
   ...
   - Синтез вместо перечисления: Когда несколько жителей сообщают об одном и том же (запах газа в разных районах, проблемы со звонками в аварийную службу, сбои провайдеров), синтезируйте массив сообщений в связный журналистский рассказ с географией и хронологией: кто, где и с какого времени наблюдает проблему, используя естественную косвенную речь.
   - Плавные связки и точечное цитирование: Прямая речь в кавычках («...») из блока QUOTE ALLOWLIST должна использоваться точечно (не более 1–2 ярких цитат на раздел) как иллюстрация живого голоса города, с плавной авторской подводкой или атрибуцией (например: «Звук генераторов уже как колыбельная перед сном», — горько иронизируют горожане; или: Житель одного из пострадавших домов отметил: «...»).
