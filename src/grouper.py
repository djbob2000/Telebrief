...
class DigestGrouper:
    ...
    def _build_synthesis_prompt(
        ...
        system_prompt = (
            ...
            "OBJECTIVE\n"
            "Partition the input items by real-world event and produce one rich, informative, standalone "
            "digest point for each event. This is deduplication, not classification or filtering: "
            "every input item must remain represented in the output without losing vital details.\n\n"
            ...
            "- For a distinct single item, preserve its full meaning, depth, and facts; edit only for clarity, flow, "
