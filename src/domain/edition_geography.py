...
_BERDYANSK_TOPONYM_RULES = (
    ...
    "«Юпитер» — местный интернет-провайдер в Бердянске (НЕ район и НЕ микрорайон города). КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО писать «в районе Юпитер» или «район Юпитер». Фразы вроде «в Юпитере нет оптоволокна» означают «у провайдера «Юпитер» нет оптоволокна» или «в сети «Юпитер»».",
    "Памятник «Самолёт» — известный памятник и городской ориентир в Бердянске на пересечении улицы Довганюка (Орджоникидзе) и Восточного (Пролетарского) проспекта (улица Волонтеров / Пионерская — следующая параллельная улица). ВНИМАНИЕ: ещё один одноимённый памятник самолёту установлен в селе Осипенко Бердянского района — различать город и село по контексту и названиям улиц. В русскоязычном тексте дайджеста и статей КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО оставлять украиноязычное название памятника («у «Літака»», «возле Літака», «у Литака»). В русском тексте писать строго по-русски: «у памятника Самолёту», «возле памятника Самолёту» или «возле Самолёта». Украинское слово «ліхтарі» переводить на русский как «фонари» (а не «лихтари»).",
)
