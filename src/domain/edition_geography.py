...
_BERDYANSK_TOPONYM_RULES = (
    "«Гора» / «Нагорная часть города» — крупный исторический и административный район города на возвышенности, объединяющий жилые массивы АЗМОЛ, Стекловолокно, АКЗ, РТС и Военный городок (не путать с районом 8 Марта!). В тексте использовать: «в нагорной части города» или «на Горе» (не «микрорайон Гора»).",
    "«8 Марта» — отдельный самостоятельный микрорайон города Бердянска. Географически он расположен на возвышенности (на горе), но НЕ входит в Нагорную часть (Гору); снизу этой горы расположены районы Колония и Макорты. В тексте писать: «в микрорайоне 8 Марта» или «в районе 8 Марта».",
    "Улица «Центральная» (ул. Центральная), улица «Карла Маркса» (ул. Карла Маркса, К. Маркса) и «Тверская» (ул. Тверская) — это ОДНА И ТА ЖЕ центральная улица в Центре Бердянска (дореволюционное название — Тверская, советское — Карла Маркса, украинское переименование 2016 г. — Центральная; оккупационные власти вернули советское название, и жители используют названия Центральная, Карла Маркса и Тверская параллельно как синонимы). КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО описывать их как разные улицы или противопоставлять друг другу! В тексте приводить к единому связному виду: «на улице Центральной (Карла Маркса)» или «на улице Карла Маркса (Центральной)». При противоречивых сообщениях жителей синтезировать их в единый пункт («на улице Центральной (Карла Маркса) данные расходятся: одни сообщают о круглосуточной воде, другие — о подаче раз в неделю на сутки или нерегулярных отключениях»).",
    "Улица «Горбенко» (ул. Горбенко, Горбенка) и улица «Лютеранская» (ул. Лютеранская) — это ОДНА И ТА ЖЕ улица в Центре города (Нижняя часть Бердянска), она НЕ относится к Колонии! Эта улица расположена в Центре, перпендикулярна улице Центральной (Карла Маркса / Тверской) и параллельна улицам Розы Люксембург (Грецкой) и Красной (Земской). КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО относить улицу Горбенко к Колонии!",
    "Городской рельеф и взаимное расположение районов: Бердянск имеет две выраженные высотные зоны — Нижняя часть у моря (Центр, Лиски, Колония, Слободка, Коса) и Нагорная часть (Гора: улицы Морозова, Пионерская, Димитрова, 50 лет СССР / Нагорная, массивы АЗМОЛ, Стекловолокно, АКЗ, РТС). Они разделены крутым 50-метровым склоном и расстоянием в 3–4 и более километров. Улицы Морозова и Пионерская находятся на Горе; улицы Центральная (Карла Маркса) и Горбенко (Лютеранская) — в Центре (внизу). КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО писать, что улицы Горы находятся «через два квартала» или «рядом» с улицами Центра или Колонии! Оборот «через два квартала» из сообщений жителей относится строго к соседним улицам внутри одного микрорайона (например, между улицами Димитрова и Морозова на Горе).",
...
def normalize_edition_toponyms(text: str, edition_slug: str = "berdyansk") -> str:
    ...
    # 11. Улица Горбенко (находится в Центре, не в Колонии)
    res = re.sub(
        r"\b(?:в\s+Колонии\s+на\s+Горбенко|на\s+Горбенко\s+в\s+Колонии)\b",
        "в Центре на улице Горбенко",
        res,
        flags=re.IGNORECASE,
    )
