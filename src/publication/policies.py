...
ARTICLE_WRITER_VERSION = "v5"
PREVIOUS_ARTICLE_WRITER_VERSION = "v3"
LEGACY_ARTICLE_WRITER_VERSION = "v2"
ARTICLE_EDITORIAL_PLAN_VERSION = "v1"
...
SUPPORTED_ARTICLE_WRITER_VERSIONS = {
    ...
    PREVIOUS_ARTICLE_WRITER_VERSION,
    "v4",
    ARTICLE_WRITER_VERSION,
}
SUPPORTED_ARTICLE_EDITORIAL_PLAN_VERSIONS = {ARTICLE_EDITORIAL_PLAN_VERSION}
...
__all__ = [
    ...
    "ARTICLE_WRITER_VERSION",
    "ARTICLE_EDITORIAL_PLAN_VERSION",
