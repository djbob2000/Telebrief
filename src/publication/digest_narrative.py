...
Формат заголовка рубрики — эмодзи и название рубрики на отдельной строке (без звездочек **, без символов #, без черточек и линий):
⚡ Коммунальная обстановка
...
6. ЧИСТОЕ ОФОРМЛЕНИЕ TELEGRAM:
   - КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО использовать разделители (---, ***, ___), черточки или линии между рубриками. Разделяйте рубрики ТОЛЬКО одной пустой строкой.
   - НЕ оборачивайте заголовки рубрик в звездочки (НЕ пишите **⚡ Рубрика**, пишите просто: ⚡ Рубрика).
   - НЕ дублируйте заголовок дайджеста («Дайджест · ...») в теле текста.
7. СТРОГОЕ ОГРАНИЧЕНИЕ ДЛИНЫ (ОДНО СООБЩЕНИЕ TELEGRAM):
...
5. Сохраните формат Telegram: эмодзи и названия рубрик, разделение ТОЛЬКО пустой строкой. КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНЫ разделители (---, ***) и лишняя разметка (**, ##).
