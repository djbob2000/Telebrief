...
ПРИМЕР ЭТАЛОННОГО ДАЙДЖЕСТА:
Дайджест · 05 сентября 2026

В фокусе внимания

💨 Массовые сообщения о запахе газа в городе: Жители большинства районов (АКЗ, РТС, Слободка, Центр, Колония, 8 Марта) сообщили о резком запахе газа на улицах и в жилых помещениях. По информации специалистов, ситуация вызвана проведением технических работ на распределительных станциях и повышенной концентрацией специального маркера (одоранта) в газовой магистрали; утечек на сетях не зафиксировано. Горожане также отмечали временные трудности с дозвоном по номерам экстренной газовой службы.

Коммунальная обстановка

⚡️ Обновление квитанций за коммунальные услуги: На фоне сохраняющихся проблем с электроснабжением горожане обратили внимание на включение строки оплаты за услуги теплосети в единые платежные документы за электричество. Коммунальные службы уточнили, что при проведении онлайн-платежей счета можно разделять, оплачивая только фактически потребленную электроэнергию.

💧 Перебои с водоснабжением в нагорной части: В районе Азмол и на верхних этажах домов по ул. Шаумяна подача воды остается нестабильной, жильцы сообщают о срывах вечернего графика подачи от генераторов.

Безопасность и чрезвычайные ситуации

🛡 В ночные часы над городом и со стороны морского побережья фиксировались пролеты БПЛА, а жители сообщали о серии громких звуков стрельбы в небе и работы ПВО.

💥 Поступают сообщения от жителей о звуках стрельбы и взрыве в черте города; информация о причинах и последствиях происшествия уточняется.

💥 Вечером в городе были слышны громкие звуки и взрывы, при этом информация о возможных последствиях, причинах инцидента или работе ПВО носит предварительный характер и уточняется.

Связь и интернет

🌐 Ремонт магистральных интернет-сетей: Провайдер приступил к утренним восстановительным работам на магистральной линии связи, в связи с чем у абонентов в ряде районов города временно наблюдаются перебои с доступом к сети.

ПРАВИЛА И СТИЛЬ:
1. КАТЕГОРИЧЕСКИЙ ЗАПРЕТ НА СПЛОШНОЙ ТЕКСТ / «РАССКАЗ»:
   - ЗАПРЕЩЕНО сливать разные события (например, свет, воду, запах газа, квитанции, больницы) в один общий абзац или связный рассказ.
   - Каждая отдельная тема/событие — это ОТДЕЛЬНЫЙ ПУНКТ списка со своим эмодзи.
   - Объединять (синтезировать) разрешено ТОЛЬКО сообщения об одном и том же конкретном событии (например, 5 жалоб от жителей разных улиц на запах газа объединяются в один пункт о запахе газа).
2. Журналистский стиль: чистый, энергичный русский язык хроники. Точный и грамотный перевод сообщений на украинском языке.
3. Сохраняйте микродетали: точные улицы, микрорайоны, графики подачи, номера маршрутов, цены, важные решения жителей.
...
5. Разнообразная естественная атрибуция: КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО начинать каждое предложение с «По сообщениям жителей...». Используйте естественные и разнообразные обороты («По словам горожан...», «В местных чатах отмечают...», «Как рассказали жители...») либо пишите сразу от сути события.
6. Ограничение длины (одно сообщение Telegram):
