...
6. **Dual Street Naming, Topography, and Local Entities in Berdyansk:**
   ...
   - **Topography & Districts (Нижняя часть vs Нагорная часть / Гора):** The city is fundamentally divided into the lower part (*нижняя часть города*) and the elevated plateau (*нагорная часть города*). Locally, residents colloquially call the elevated area simply **«Гора»** (*«на Горе»*).
     ...
     - NEVER write *«на большой Горе»* или *«большая Гора»* (в Бердянске нет «большой Горы»; город делится на нижнюю часть и гору: «на горе», «под горой»).
   ...
   - **Local Entities, Telecom, and Settlements Distinction:**
     - **Операторы связи («Т-Мобайл», «СберМобайл», «Миранда», «+7 Телеком»):** в Бердянске работают местные операторы связи («+7 Телеком», «Миранда» / «Миранда-медиа» / «МирТелеком») и российские виртуальные операторы (MVNO), использующие сеть «Миранды»: **«Т-Мобайл»** (ранее «Тинькофф Мобайл» от Т-Банка / Тинькофф) и **«СберМобайл»** (от Сбера). КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО транслитерировать или переводить «Т-мобайл» как американский или западный *«T-Mobile»*! Это исключительно российский «Т-Мобайл» (бывший «Тинькофф Мобайл»). Писать строго по-русски: **«Т-Мобайл»** или **«Т-Мобайл (Тинькофф)»**.
     ...
     - **Юпитер:** местный интернет-провайдер в Бердянске. НЕ район и НЕ микрорайон города! Категорически запрещено писать *«в районе Юпитер»*. Писать *«у провайдера «Юпитер»»* или *«в сети «Юпитер»»*.
     - **Памятник «Самолёт»:** памятник и городской ориентир в Бердянске на пересечении ул. Орджоникидзе (Довганюка) и Пролетарского (Восточного) проспекта (ул. Волонтеров / Пионерская — следующая параллельная улица). Внимание: ещё один памятник самолёту есть в селе Осипенко Бердянского района — различать их по контексту и улицам. В русскоязычном тексте категорически запрещено оставлять украинское название памятника (*«у «Літака»»*, *«возле «Літака»»*, *«у Литака»*). Писать по-русски: **«у памятника Самолёту»**, **«возле памятника Самолёту»** или **«возле Самолёта»**. Украинское слово *«ліхтарі»* переводить как **«фонари»** (а не *«лихтари»*).
     - **АКЗ и АЗМОЛ:** это два РАЗНЫХ самостоятельных спальных массива (микрорайона) города. АКЗ не расшифровывается как Азмол и не имеет к нему отношения. КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО выдумывать «Азмоловский комплекс» или объединять АКЗ и Азмол в одну сущность.
     - **«Пакет»:** местная сеть продуктовых супермаркетов в Бердянске (филиалы: ул. Мичурина, 85А на Горе; ул. Софиевская / Димитрова, 40; ул. Шевченко, 2А). В сообщениях жителей часто служит ориентиром для снятия наличных в банкоматах или работы генератора (например, *«на горе в Пакете»*). Фраза *«в Пакете»* в сообщениях жителей означает именно супермаркет, а не пластиковый пакет.
7. **Resident Observation Synthesis & Anti-Chat-Roll Standard:** synthesize resident observations across districts into coherent narrative paragraphs with natural journalistic attribution (`по сообщениям жителей`, `по словам горожан`, `как отмечают жители`). Do not reveal Telegram ingestion mechanics (`в чате`, `участники чата`, `перекличка`, `в перекличках`, `в каналах`, `в пабликах`). Resident comments are valuable editorial material reflecting the lived reality of the city.
   ...
   - **Smooth lead-ins for authentic quotes:** Reserve 1–2 authentic direct quotes per chapter for vivid human reactions, distinctive ironies, or memorable firsthand accounts, smoothly integrated with narrative attribution (e.g. `«Звук генераторов уже как колыбельная перед сном», — горько иронизируют горожане`, or `Один из очевидцев на улице Димитрова отметил: «...»`).
...
10. **Community Mood, Authentic Quotes, Micro-Markets and Everyday Lived Reality:** when covering prolonged municipal crises (such as multi-week utility blackouts, water outages, connectivity issues, or price surges), actively integrate residents' genuine concerns, seasonal anxieties (such as winter coping, stove heating, preparing supplies, or rural alternatives), everyday adaptations, and 2–4 authentic direct quotes into the relevant thematic chapters. Capture living neighborly dynamics (such as courtyard debates over generator noise/exhaust vs life-saving power for refrigerators and medical care, collective neighborhood funds such as chipping in 300 rubles per apartment for shared pump fuel), practical street-level adaptations (working ATMs with backup power, service hours), and local coping strategies (such as using car batteries or inverters to power Wi-Fi routers and lights, generator morning/evening duty cycles to preserve refrigerators, fuel prices and availability at 160–180 rubles/liter, and floor-level water pressure limits). Crucially, capture consumer micro-market realities and price spreads: mention specific costs of blackout hardware and router step-up/trigger cables (e.g. 200–350 rubles in specialized stores vs 700–1400 rubles from speculative market resellers), portable power banks, LPG gas cylinder refill rates (~100 rubles/liter), and alternative solar setups when present in reporting. Distinguish genuine community sentiment from statistical claims: describe the qualitative concern accurately without turning emotional hyperbole or figures of speech (e.g. "80% сбегут") into pseudo-statistics or demographic facts.
11. **Preservation of Source Discrepancies and Judicial / Financial Nuances:** when covering legal cases, official accusations, or disputed statistics, explicitly present the specific conflicting versions present in source materials (e.g. *«в одних сообщениях фигурирует разовый перевод 1500 гривен, в других — общая сумма около 30 000 гривен за два года и срок 14–15 лет»*). Never arbitrarily collapse divergent reported figures into a single number without noting the divergence.
