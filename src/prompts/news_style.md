...
6. **Dual Street Naming, Topography, and Local Entities in Berdyansk:**
   ...
   - **Local Entities, Telecom, and Settlements Distinction:**
     ...
     - **«Пакет»:** местная сеть продуктовых супермаркетов в Бердянске (филиалы: ул. Мичурина, 85А на Горе; ул. Софиевская / Димитрова, 40; ул. Шевченко, 2А). В сообщениях жителей часто служит ориентиром для снятия наличных в банкоматах или работы генератора (например, *«на горе в Пакете»*). Фраза *«в Пакете»* в городских перекличках означает именно супермаркет, а не пластиковый пакет.
