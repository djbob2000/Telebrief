...
class LightFactChecker:
    ...
    def _build_system_prompt(self) -> str:
        return (
            ...
            "scale overstatements (e.g. 'в значительной части города', 'весь город' / 'entire city', 'most districts', 'во многих районах' when observations come from several streets/districts but broad prevalence or denominator is unproven); "
