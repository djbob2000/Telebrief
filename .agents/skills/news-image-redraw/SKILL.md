...
1. **Strictly NO Text on Image (`NO text, NO letters, NO words, NO signs`):** AI text rendering often produces unreadable gibberish or unintended English signage (e.g. "GROCERY", "STORE"). Explicitly prohibit English words, signage, and text on buildings, t-shirts, storefronts, and documents.
2. **Regional Topography & Architectural Authenticity:**
...
3. **Indoor / Medium Shots Advantage:**
...
3. **No Fabricated Disasters / Fake Evidence:**
...
```text
[STYLE & OPTICS]: Realistic editorial photojournalism, authentic documentary photography, 35mm lens, candid natural shot, natural lighting, gritty authentic textures, no studio gloss.
